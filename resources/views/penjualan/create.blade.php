            ...
            <section class="content">
                ...
                <form action="{{ route('penjualan.store') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" id="tenggat_waktu" name="tenggat_waktu" value="{{ old('tenggat_waktu') }}" required>
                    </div>
                    <div class="form-group">
                        <label for="diskon">Diskon (%)</label>
                        <input type="number" id="diskon" name="diskon" min="0" max="100" value="{{ old('diskon', 0) }}" required>
                    </div>
