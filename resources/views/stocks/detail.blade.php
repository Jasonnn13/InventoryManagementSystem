                        ...
                        @foreach($stocks as $stock)
                            ...
                            <tr class="{{ $isOverdue ? 'overdue' : '' }}">
                                ...
                                <td data-label="Gudang">
                                    @foreach($stock->gudangs as $gudang)
                                        {{ $gudang->name }}@if(!$loop->last), @endif
                                    @endforeach
                                </td>
                                ...
                                <td data-label="Harga Beli">Rp. {{ number_format($stock->beli, 0, ',', '.') }}</td>
                                <td data-label="Harga Jual">Rp. {{ number_format($stock->jual, 0, ',', '.') }}</td>
