...
<head>
    ...
    <title>Edit Rincian Penjualan</title>
    <style>
        body {
    ...
    <div class="container">
        ...
        <main class="main-content">
            ...
            <section class="content">
                <h2>Edit Rincian Penjualan</h2>
                <form action="{{ route('rincianpenjualan.update', $rincianpenjualan->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-actions">
                        <button type="submit" class="btn btn-primary">Update Rincian</button>
                        <a href="{{ route('rincianpenjualan.index', ['penjualan_id' => $penjualan->id]) }}" class="btn btn-secondary">Cancel</a>
                    </div>
                </form>
            </section>  
        </main>
